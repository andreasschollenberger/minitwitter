# Mini-Twitter Projekt

## Projekt beschreib
Die Vorlage laut Figma https://www.figma.com/file/3AO216bDpIIubHvfAtRqCI/Mini-Twitter?type=design&node-id=0-1&mode=design&t=fd4rig67uMdqS8Sd-0 ist das Layout und die Funktionalität bereits vorgegeben gewesen.

1. Startseite, hier werden alle Tweets angezeigt die auf der Datenbank vorkommen. Der Navigations Button "Tweet ansehen" nimmt die "Id" von dem Tweet mit und Zeigt es auf der nächsten seite (singletweet).

2. Singletweet, auf dieser seite kann man den Tweet aus der Datenbank Löschen. Den Tweet Bearbeiten ist eine weitere Funktion die auf dieser seite möglich ist.

3. Tweet Bearbeiten, in den eingabe felder, ist der Text bereit vorhanden den man Aktualisieren will. mit dem Absenden klick auf "Tweet aktualisieren" springt die Navigation zurück zur Startseit.

4. Haeder, Im Haeder der auf jeder Seite anzutreffen ist, ermöglicht zu jeder Zeit auf die Navihation zu der Seite create Tweet zu gelangen.

5. Tweet erstellen, hier wird ein neuer Tweet erstellt und beim Speichern direkt an die Datenbank gesendet. dabei wird eine neue Id für den neuen Tweet angelegt, der auf der Startseite als angezeitgt wird. 
